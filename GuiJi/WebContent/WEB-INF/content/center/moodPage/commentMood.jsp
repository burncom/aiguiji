...
<body>
	<%--处理想参加的事情 --%>
	<s:form action="commentMood" enctype="multipart/form-data" method="post">
	<table width=780 align="center" border="1">
		<s:hidden name="msgId" value='%{msgId}'></s:hidden>
		<tr>
			<td colspan="2"><s:textfield name="messageInfo.msg_content" theme="simple"/></td>
		</tr>
		<tr>
			<td colspan="2">
		...
		<table id="idcomment" width=780 align="center" border="1">
			...
			<tr>
				<td>
					...
					<a id="idreply" href="replyMood.action?commentUserName=<s:property value="commentUserName"/>&msgId=<s:property value="msgId"/>">回复</a>
				</td>
			</tr>
			</table>
		</s:iterator>
